...
public:
	...
	void mergeJoin(double memCapacity, int smallerSide);

	void inMem(EfficientMap <Record, KeyInt>& memRecords, RelationalOp* producer, int sideNum);
